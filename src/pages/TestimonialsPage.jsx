...
const testimonials = [
  {
    ...
    role: "student",
    country: "Bogor",
    image: <div className="w-12 h-12 bg-linear-to-br from-pink-400 to-pink-600 rounded-full flex items-center justify-center text-white font-bold">FN</div>,
  ...
  },
  {
    ...
    role: "student parent",
    country: "Bogor",
    image: <div className="w-12 h-12 bg-linear-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center text-white font-bold">MN</div>,
  ...
  },
  {
    ...
    role: "student parent",
    country: "Bogor",
    image: <div className="w-12 h-12 bg-linear-to-br from-purple-400 to-purple-600 rounded-full flex items-center justify-center text-white font-bold">RN</div>,
