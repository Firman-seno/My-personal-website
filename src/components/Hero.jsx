          ...
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
            ...
            <div className="mt-4">
              <a
                href="cv/Firman.jpg"
                download="Firman.jpg"
                className="inline-flex items-center justify-center px-33 py-3.5 border-2 border-teal-600 text-teal-600 font-semibold rounded-lg hover:bg-teal-600 hover:text-white transition-all duration-200"
              >
